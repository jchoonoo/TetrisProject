...
public class LeftZigSag extends AbstractTetrisShape {

  /**
   * creates a {@code LeftZigSag} object
   */
  public LeftZigSag() {
    super();
    pivotCellNumber = 2;
  ...
  public Position[][] rotationPositions() {
    ...
    rotationPositions[1][0] = new Position(this.x - 1, this.y - 1);
    rotationPositions[1][1] = new Position(this.x, this.y - 1);
